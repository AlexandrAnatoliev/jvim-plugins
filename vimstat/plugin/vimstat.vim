...
function! s:StartVimStat()
  silent !java -jar ~/.vim/pack/my-plugins/start/vimstat/target/vimstat-0.8.41.jar start &
endfunction
" }}}
...
function! s:UpdateVimStat()
  silent !java -jar ~/.vim/pack/my-plugins/start/vimstat/target/vimstat-0.8.41.jar update &
endfunction
" }}}
...
function! s:StopVimStat()
  silent !java -jar ~/.vim/pack/my-plugins/start/vimstat/target/vimstat-0.8.41.jar stop &
endfunction
" }}}
